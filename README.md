# PHP Template: Standard Library

This repository serves as the definitive starting point for developing high-quality PHP libraries within the ecosystem. It comes pre-configured with the complete suite of quality assurance tools, strict coding standards, and continuous integration workflows required for production-grade software.

The template enforces a "strict-by-default" configuration. It includes setups for PHPStan (Max), PHP-CS-Fixer, and PHPUnit, ensuring that any new library begins its lifecycle with zero technical debt and full compliance with the architectural guidelines of the author.
